...
export const CORE_RESOURCE_TAB_META = [
  ...
  { key: 'exercises', label: '个性化题单', icon: '✏️', agent: 'ExerciseAgent' },
  ...
  { key: 'ppt', label: '课程讲义 PPT', icon: '📄', agent: 'PptAgent' },
  { key: 'video_script', label: '教学短视频', icon: '🎥', agent: 'VideoScriptAgent' },
] as const
