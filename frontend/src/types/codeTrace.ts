...
export interface CounterexampleResult {
  selected_case: Record<string, unknown> | null
  source: string
...
export interface ExecutionEvidence {
  ...
  total_cases?: number
  passed_cases?: number
  failed_test_cases?: Array<Record<string, unknown>>
  execution_trace?: Record<string, unknown>
  bug_diagnosis?: Record<string, unknown>
  related_knowledge_points?: Array<Record<string, unknown>>
  layered_hints?: Array<Record<string, unknown>>
...
export interface AiDiagnoseResponse {
  ...
  first_divergence?: FirstDivergenceResult | null
  counterexample?: CounterexampleResult | null
  bug_record_id?: number | null
  trace_record_id?: number | null
}
