...
export const HELP_FAQ: HelpFaqItem[] = [
  ...
  },
  {
    ...
    question: '目前有哪些算法模块？',
    answer:
      '已上线 11 个模块：数组、链表、哈希表、字符串、双指针、栈与队列、二叉树、回溯、贪心、动态规划、单调栈。图论模块规划中。每个模块含讲解、动画、OJ 题单与闯关小游戏。',
  },
  {
    id: 'faq-game',
    category: '学习模块',
  ...
  },
  {
    ...
    question: '如何本地启动完整环境？',
    answer:
      '后端：cd backend，激活虚拟环境后 uvicorn main:app --reload --port 9000。前端：cd frontend，npm install && npm run dev。也可在仓库根目录运行 start.bat 一键启动。需在 backend/.env 配置 JWT_SECRET 与 SILICONFLOW_API_KEY 等。',
  },
]
