...
const prefetchByPath: Record<string, () => Promise<unknown>> = {
  ...
  '/student-roster': () => import('@/views/StudentRosterView.vue'),
  '/oj-analytics': () => import('@/views/OjAnalyticsView.vue'),
  '/teacher-workbench': () => import('@/views/TeacherWorkbenchView.vue'),
  '/teacher-guide': () => import('@/views/TeacherGuideView.vue'),
