...
export const GAME_SHELL_META: Record<string, Record<string, GameLevelShellMeta>> = {
  'binary-search': {
    find: {
      ...
      stateKeys: [
        { key: 'L', label: 'L', color: '#3a8a9e' },
        { key: 'R', label: 'R', color: '#9e6e88' },
        { key: 'M', label: 'mid', color: '#9c8540' },
      ],
  ...
  'hash-locker': {
    basic: {
      ...
      stateKeys: [
        { key: 'mod', label: '桶数', color: '#3a8a9e' },
        { key: 'key', label: '当前 key', color: '#9e6e88' },
      ],
    ...
    rehash: {
      ...
      stateKeys: [
        { key: 'phase', label: '阶段', color: '#7a6e9e' },
        { key: 'key', label: '当前 key', color: '#9e6e88' },
      ],
  ...
  palindrome: {
    ...
    'kmp-next': {
      ...
      stateKeys: [{ key: 'step', label: '填写位', color: '#9c8540' }],
  ...
  'two-pointers-race': {
    dedup: {
      ...
      stateKeys: [
        { key: 'L', label: 'write', color: '#3a8a9e' },
        { key: 'R', label: 'right', color: '#9e6e88' },
        { key: 'w', label: 'write', color: '#7a6e9e' },
      ],
    ...
    cycle: {
      ...
      stateKeys: [
        { key: 'slow', label: 'slow', color: '#7a6e9e' },
        { key: 'fast', label: 'fast', color: '#9e6e4a' },
      ],
  ...
  'greedy-courier': {
    jump: {
      ...
      stateKeys: [
        { key: 'pos', label: '当前位置', color: '#3a8a9e' },
        { key: 'reach', label: '最远可达', color: '#9c8540' },
      ],
    ...
    interval: {
      ...
      stateKeys: [{ key: 'picked', label: '已选', color: '#4a8a5e' }],
  ...
  'knapsack-lite': {
    knapsack: {
      ...
      stateKeys: [
        { key: 'w', label: '已用容量', color: '#3a8a9e' },
        { key: 'v', label: '总价值', color: '#9c8540' },
      ],
    ...
    rob: {
      ...
      stateKeys: [{ key: 'sum', label: '当前金额', color: '#4a8a5e' }],
    ...
    stairs: {
      ...
      stateKeys: [{ key: 'i', label: '填写下标', color: '#9c8540' }],
  ...
  'backtrack-room': {
    n4: {
      ...
      stateKeys: [{ key: 'queens', label: '已放皇后', color: '#9e6e88' }],
    ...
    perm: {
      ...
      stateKeys: [{ key: 'perm', label: '当前路径', color: '#7a6e9e' }],
  ...
  'tree-cave': {
    traverse: {
      ...
      stateKeys: [{ key: 'order', label: '已访问', color: '#3a8a9e' }],
    ...
    bst: {
      ...
      stateKeys: [{ key: 'order', label: '中序序列', color: '#4a8a5e' }],
    ...
    path: {
      ...
      stateKeys: [
        { key: 'path', label: '路径和', color: '#9c8540' },
        { key: 'sum', label: '当前和', color: '#3a8a9e' },
      ],
  ...
  'monotonic-barrier': {
    temp: {
      ...
      stateKeys: [
        { key: 'processed', label: '进度', color: '#3a8a9e' },
        { key: 'stack', label: '栈顶', color: '#9c8540' },
      ],
    ...
    rect: {
      ...
      stateKeys: [
        { key: 'processed', label: '进度', color: '#3a8a9e' },
        { key: 'stack', label: '栈', color: '#7a6e9e' },
      ],
  ...
  'canteen-stack-queue': {
    stack: {
      ...
      stateKeys: [
        { key: 'lives', label: '生命', color: '#9e5a5a' },
        { key: 'score', label: '得分', color: '#9c8540' },
      ],
    ...
    paren: {
      ...
      stateKeys: [
        { key: 'cursor', label: '扫描位置', color: '#3a8a9e' },
        { key: 'stack', label: '栈深', color: '#7a6e9e' },
      ],
    ...
    deque: {
      ...
      stateKeys: [{ key: 'window', label: '窗口', color: '#9c8540' }],
  ...
  'graph-explorer': {
    representation: {
      ...
      stateKeys: [
        { key: 'edge', label: '当前边', color: '#3a8a9e' },
        { key: 'done', label: '已补方向', color: '#4a8a5e' },
      ],
    ...
    bfs: {
      ...
      stateKeys: [
        { key: 'queue', label: '队列', color: '#3a8a9e' },
        { key: 'dist', label: '目标距离', color: '#9c8540' },
      ],
    ...
    dfs: {
      ...
      stateKeys: [
        { key: 'path', label: '递归栈', color: '#7a6e9e' },
        { key: 'seen', label: '已访问', color: '#4a8a5e' },
      ],
  ...
  'algo-detective': {
    'dfs-queue': {
      ...
      stateKeys: [{ key: 'flag', label: '已标记', color: '#9e5a5a' }],
