/** 字符串模块学习进度（本地存储；与后端 `learning_progress.payload` 中的键一致） */
export const STRING_SECTION_STORAGE_KEY = 'alp-string-section-done-v1'

const STORAGE_KEY = STRING_SECTION_STORAGE_KEY
