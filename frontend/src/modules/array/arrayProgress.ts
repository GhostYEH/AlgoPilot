/** 数组模块学习进度（本地存储；与后端 `learning_progress.payload` 中的键一致） */
export const ARRAY_SECTION_STORAGE_KEY = 'alp-array-section-done-v1'

const STORAGE_KEY = ARRAY_SECTION_STORAGE_KEY
