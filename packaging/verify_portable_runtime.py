"""Runtime smoke test executed by the frozen AlgoPilot executable."""
...
assert len(trace_result.steps) > 0, trace_result
    ...
    json.dumps(
        {
            ...
            "gpp": gpp,
            "gdb": gdb,
            "cpp_verdict": cpp_result.verdict,
            "trace_verdict": trace_result.verdict,
            "trace_steps": len(trace_result.steps),
        },
        ensure_ascii=False,
    )
)
